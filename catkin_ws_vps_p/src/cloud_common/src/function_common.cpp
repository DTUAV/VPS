#include "../include/cloud_common/function_common.h"
DTUAVCARS::data_size getDataSizeStuct(long size)
{
  DTUAVCARS::data_size data_size_stuct;
...
long getDataSize(DTUAVCARS::data_size data_size_stuct)
{
