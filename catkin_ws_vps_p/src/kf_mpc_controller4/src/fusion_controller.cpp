...
fusion_controller::fusion_controller()
{
  ...
  _controller_info_pub_topic = "/controller_info";
  n.getParam("controller_info_pub_topic",_controller_info_pub_topic);
  ...
  _controller_info_pub = n.advertise<dt_message_package::part_guide_controller_info>(_controller_info_pub_topic,1);
...
void fusion_controller::virtual_guide_control_sub_cb(const std_msgs::Int8::ConstPtr &msg)
{
...
void *fusion_controller::guide_change_run(void *args)
{
  ...
  dt_message_package::part_guide_controller_info controller_info_msg;
  while(ros::ok())
  {
    ...
    controller_info_msg.mpc_output_x = fusion->_mpc_controller_output_x;
    controller_info_msg.mpc_output_y = fusion->_mpc_controller_output_y;
    controller_info_msg.mpc_output_z = fusion->_mpc_controller_output_z;
    controller_info_msg.guidance_output_x = fusion->_virtual_guide_output_x;
    controller_info_msg.guidance_output_y = fusion->_virtual_guide_output_y;
    controller_info_msg.guidance_output_z = fusion->_virtual_guide_output_z;
    controller_info_msg.target_output_x = fusion->_target_cmd_x;
    controller_info_msg.target_output_y = fusion->_target_cmd_y;
    controller_info_msg.target_output_z = fusion->_target_cmd_z;

    fusion->_controller_info_pub.publish(controller_info_msg);
