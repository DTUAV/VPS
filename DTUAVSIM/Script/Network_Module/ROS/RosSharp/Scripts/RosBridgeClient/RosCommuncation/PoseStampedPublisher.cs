...
namespace RosSharp.RosBridgeClient
{
    public class PoseStampedPublisher : UnityPublisher<MessageTypes.Geometry.PoseStamped>
    {
        ...
        public bool IsPublishLocalPosition = false;
        ...
        {
            _homePosition = PublishedTransform.position;
            base.Start();
            InitializeMessage();
            _isStop = false;
        ...
        private void UpdateMessage()
        {
            ...
            if (IsPublishLocalPosition)
            {
                GetGeometryPoint((PublishedTransform.position-_homePosition).Unity2Ros(), message.pose.position);
