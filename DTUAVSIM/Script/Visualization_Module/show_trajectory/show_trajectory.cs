...
namespace DTUAVCARS.DTVisualization
{
    ...
    public class show_trajectory
    {
        ...
        public show_trajectory(Material mat, Color color, float widthX, float widthY, Vector3 lastPosition, bool isPlot, float duration,bool isAuto)
        {
            _mat = mat;
            _color = color;
            _widthX = widthX;
