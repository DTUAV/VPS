 ...
 *
 *  Update Information:
 *                     First: 2021-8-6 In Guangdong University of Technology By Yang Yuanlin
 *
 */
using System.Collections;
using System.Collections.Generic;
using UnityEngine;
using DTUAVCARS.Base;
using DTUAVCARS.Math.DataStructure;
using DTUAVCARS.TF;

namespace DTUAVCARS.UAV
{
    public class UAV4Implement : DOF6
    {
        public List<Motor> UavMotors;
        public ControlWay ControlWayInstace;
        ...
        {
            float yaw = 0.0f;
            foreach (Motor uavMotor in UavMotors)
            {
                Transform motorTransform = uavMotor.MotorObject.transform;

                if (ControlWayInstace == ControlWay.AutomaticFlight)
                {
