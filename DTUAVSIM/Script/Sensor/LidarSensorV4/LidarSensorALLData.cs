...
{
    public class LidarSensorALLData 
    {
        ...
        public LidarSensorALLData(Vector3 position, float distance, float verticalAngle, float horizontalAngle, Vector3 hitPoint, int LaserId)
        {
