...
#define Server_10 561
#define Server_11 562
#define Server_12 563
#define Server_13 564
#define Server_14 565
#define Server_15 566
#define Server_16 567
#define Server_17 568
#define Server_18 569
#define Server_19 570

#define Server_20 571
#define Server_21 572
#define Server_22 573
#define Server_23 574
#define Server_24 575
#define Server_25 576
#define Server_26 577
#define Server_27 578
#define Server_28 579
#define Server_29 580

#define Server_30 581
#define Server_31 582
#define Server_32 583
#define Server_33 584
#define Server_34 585
#define Server_35 586
#define Server_36 587
#define Server_37 588
#define Server_38 589
#define Server_39 590

#define Server_40 591
#define Server_41 592
#define Server_42 593
#define Server_43 594
#define Server_44 595
#define Server_45 596
#define Server_46 597
#define Server_47 598
#define Server_48 599
#define Server_49 600
...
#define VirtualGuideMessageID 117
struct VirtualGuideMessage
{
  float linearVelocityX;
  float linearVelocityY;
  float linearVelocityZ;
  XTOSTRUCT(O(linearVelocityX,linearVelocityY,linearVelocityZ));
};
#define VirtualGuideControlMessageID 118
struct VirtualGuideControlMessage
{
  int guideType;
  XTOSTRUCT(O(guideType));
};

#define ObjectMotionModelMessageID 119
struct ObjectMotionModelMessage
{
  std::vector<float> A;
  std::vector<float> B;
  std::vector<float> W;
...
#define NetworkDelayTimeMessageID 120
struct NetworkDelayTimeMessage
{
  float delay_time;
  XTOSTRUCT(O(delay_time));
};

#define ModelLearnControlMessageID 121
struct ModelLearnControlMessage
{
  bool learn;
  XTOSTRUCT(O(learn));
};
