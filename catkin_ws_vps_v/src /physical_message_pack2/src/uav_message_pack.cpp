...
uav_message_pack::uav_message_pack()
{
  ...
  _system_running_control_sub = n.subscribe(_system_running_control_sub_topic,1,&uav_message_pack::system_running_control_sub_cb,this);

  _system_running_id = 0;

}

void uav_message_pack::system_running_control_sub_cb(const std_msgs::Int32ConstPtr &msg)
{
