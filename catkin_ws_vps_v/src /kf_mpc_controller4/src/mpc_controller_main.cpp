...
int main(int argc, char *argv[])
{
  ...
  n.getParam("sample_time",sample_time_tme);
  ...
  float sample_time = sample_time_tme;//0.0002;//1.5;//0.002;//1.5;//0.5//0.2
  float control_out_cost = 0.0002;//0.0002;
  float tracking_cost = 0.9;//1.1:zhengdong;//0.9;
  n.getParam("control_out_cost",control_out_cost);
  n.getParam("tracking_cost",tracking_cost);
