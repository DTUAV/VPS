...
private:
  ...
  std::string _predictor_x_pub_topic;
  std::string _predictor_y_pub_topic;
  std::string _predictor_z_pub_topic;
  std::string _predictor_cur_position_pub_topic;
  ...
  ros::Publisher _predictor_x_pub;
  ros::Publisher _predictor_y_pub;
  ros::Publisher _predictor_z_pub;

  ros::Publisher _predictor_cur_position_pub;
